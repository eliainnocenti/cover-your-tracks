...
const STEPS = [
  ...
  },
  {
    ...
    title: 'Hints',
    color: 'var(--amber-main)',
    description: "Stuck? Use the hint system — 3 tiers of increasing detail. Tier 1 gives a nudge (−10 pts), Tier 2 is more specific (−20 pts), and Tier 3 practically gives it away (−30 pts). Try without hints first!",
  },
]
